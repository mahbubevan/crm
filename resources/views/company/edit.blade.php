                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('company.update',$data->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="url" class="form-control @error('url') is-invalid @enderror" name="url" value="{{ old('url') ? : $data->url }}">
                                @error('url')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="file" id="logo" class="form-control-file @error('logo') is-invalid @enderror" name="logo">
