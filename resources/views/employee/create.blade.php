...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h4>Add New Employee</h4></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('employee.store') }}">
                        ...
                        <div class="form-group row">
                                <label for="phone" class="col-md-4 col-form-label text-md-right">Cell Number</label>
                                <div class="col-md-6">
                        ...
                        <div class="form-group row">
                                <label for="company_id" class="col-md-4 col-form-label text-md-right">Available Company List</label>
                                <div class="col-md-6">
